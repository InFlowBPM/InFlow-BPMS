...
namespace strICT.InFlow.WF.Activities.SBPM {
    ...
    public partial class FunctionState : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FunctionState).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FunctionState));
        ...
        private string FindResource() {
            string[] resources = typeof(FunctionState).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FunctionState.g.xaml") || resource.Equals("FunctionState.g.xaml"))) {
                    return resource;
                }
            }
