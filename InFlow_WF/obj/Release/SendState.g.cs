...
namespace strICT.InFlow.WF.Activities.SBPM {
    ...
    public partial class SendState : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SendState).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SendState));
        ...
        private string FindResource() {
            string[] resources = typeof(SendState).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SendState.g.xaml") || resource.Equals("SendState.g.xaml"))) {
                    return resource;
                }
            }
