...
namespace strICT.InFlow.WF.Activities.SBPM {
    ...
    public partial class ReceiveStateT : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        private string FindResource() {
            string[] resources = typeof(ReceiveStateT).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ReceiveStateT.g.xaml") || resource.Equals("ReceiveStateT.g.xaml"))) {
                    return resource;
                }
            }
